...
window.geometry("420x523+100+100")
...
button12 = tkinter.Button(window, text="=",overrelief="solid", width=10, height=6,background="#A136C2",command=lambda: keyIn("="), repeatdelay=1000, repeatinterval=100)
#button1.pack()
button12.grid(row=7, column=5)

button13 = tkinter.Button(window, text="-",overrelief="solid", width=10, height=6,background="#A136C2",command=lambda: keyIn("-"), repeatdelay=1000, repeatinterval=100)
#button1.pack()
button13.grid(row=7, column=2)

button14 = tkinter.Button(window, text=".",overrelief="solid", width=10, height=6,background="#A136C2",command=lambda: keyIn("."), repeatdelay=1000, repeatinterval=100)
#button1.pack()
button14.grid(row=7, column=4)

button133 = tkinter.Button(window, text="C",overrelief="solid", width=10, height=6,background="#A136C2",command=lambda: keyIn("비타민C"), repeatdelay=1000, repeatinterval=100)
#button1.pack()
button133.grid(row=3, column=6)
